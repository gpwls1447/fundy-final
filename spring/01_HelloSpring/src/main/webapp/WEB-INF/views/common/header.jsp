...
<%--               	<li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath }/demo/demo.do">demo</a></li> --%>
               		...
               		<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">demo</a>
               			<div class="dropdown-menu" aria-labelledy="navbarDropdown">
	               			<a class="dropdown-item" href="${pageContext.request.contextPath }/demo/demo.do">demo 등록</a>
	               			<a class="dropdown-item" href="${pageContext.request.contextPath }/demo/selectList.do">demo 리스트</a>
               			</div>
               		</li>
               </ul>
	           ...
	           <c:if test="${loggedMember != null }">
	           	<span><a href="#">${loggedMember.username }</a>님 환영합니다!</span>
