      ...
      <form id="devFrm">
         ...
         <div class="form-group row">
      	...
      	<div class="list-group">
	      	...
	      	<button type="button" onclick="demo5();" class="list-group-item list-group-item-action">
	      		파라미터 핸들링 - select 데이터!
	      	</button>
      	</div>
      </form>
...
<script>
	...
	function demo4() {
		$("#devFrm").attr("action", "${pageContext.request.contextPath}/demo/insert.do");
		$("#devFrm").attr("method", "post");
		$("#devFrm").submit();
	}
	
	function demo5() {
		$("#devFrm").attr("action", "${pageContext.request.contextPath}/demo/select.do");
		$("#devFrm").attr("method", "post");
		$("#devFrm").submit();
	}
	
	function demo6() {
		$("#devFrm").attr("action", "${pageContext.request.contextPath}/demo/demoList.do");
		$("#devFrm").attr("method", "post");
		$("#devFrm").submit();
	}
